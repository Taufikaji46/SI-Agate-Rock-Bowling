...
public class CameraFollow : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        else if (transform.position.z < z_offset && !triggerCam)
        {
        ...
        else if((rock.isResetting == true || rock2.isResetting == true || rock3.isResetting == true) && triggerCam)
        {
            triggerCam = false;
            transform.position = startCamPosition;
            transform.rotation = startCamRotation;
